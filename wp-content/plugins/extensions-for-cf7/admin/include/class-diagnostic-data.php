 ...
 * Class.
 */
if ( ! class_exists( 'Extensions_Cf7_Diagnostic_Data' ) ) {
    class Extensions_Cf7_Diagnostic_Data {
        ...
        private function __construct() {
            $this->project_name = 'Extensions For CF7';
            $this->project_type = 'wordpress-plugin';
            $this->project_version = CF7_EXTENTIONS_PL_VERSION;
            ...
            $this->project_pro_slug = 'extension-for-cf7-pro/cf7-extensions-pro.php';
        ...
        private function is_show_core_notice() {
            $result = get_option( 'ht_cf7extensions_diagnostic_data_notice', 'yes' );
...
/*
            ...
            */
            ...
            $button_link_1 = add_query_arg( array( 'ht_cf7extensions-diagnostic-data-agreed' => 1 ) );
            ...
            <div class="ht_cf7extensions-diagnostic-data-notice notice notice-success">
                ...
                <p class="ht_cf7extensions-diagnostic-data-buttons">
                    <a href="<?php echo esc_url( $button_link_1 ); ?>" class="ht_cf7extensions-diagnostic-data-button ht_cf7extensions-diagnostic-data-agree button button-primary"><?php echo esc_html( $button_text_1 ); ?></a>
    ...
    Extensions_Cf7_Diagnostic_Data::get_instance();
}